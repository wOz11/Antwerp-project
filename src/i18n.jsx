...
const translations = {
  fr: {
    ...
    aov_cancel: "Annuler",
    aov_addNew: "Prendre un nouveau rendez-vous",
    // Portal
    home: "Accueil",
    ...
    appTitle: "Care-Slot - Hôpital ZAS",
    language: "Langue",
  ...
  en: {
    ...
    aov_cancel: "Cancel",
    aov_addNew: "Book a new appointment",
    // Portal
    home: "Home",
    portal_about: "About",
    portal_services: "Services",
    ...
    appTitle: "Care-Slot - ZAS Hospital",
    language: "Language",
  ...
  nl: {
    ...
    aov_cancel: "Annuleren",
    aov_addNew: "Nieuwe afspraak maken",
    // Portal
    home: "Home",
    ...
    portal_info_address_val: "Grote Markt 1, Antwerpen",
    appTitle: "Care-Slot - ZAS Ziekenhuis",
    language: "Taal",
